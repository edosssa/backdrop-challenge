...
export declare function sendResponse(response: Response<any, Record<string, any>, number>, type: string, data: string);

export declare function graphiql(data: GraphiQLData): Middleware;
